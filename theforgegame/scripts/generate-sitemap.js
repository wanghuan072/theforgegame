...
const baseRoutes = [
  ...
  { path: '/pickaxes-tier-list', name: 'tier-list-pickaxes', priority: 0.8, changefreq: 'monthly' },
  { path: '/races-tier-list', name: 'tier-list-races', priority: 0.8, changefreq: 'monthly' },
  { path: '/weapons-tier-list', name: 'tier-list-weapons', priority: 0.8, changefreq: 'monthly' },
