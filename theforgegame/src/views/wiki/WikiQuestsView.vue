<template>
  <div class="wiki-quests-view page-container">
    <div class="container">
      <div class="page-header">
        <h1 class="page-title">The Forge Roblox Quests</h1>
        <p class="page-subtitle">
          Complete guide to all quests in The Forge. Learn about different quest types, objectives, and rewards.
        </p>
      </div>
      ...
      <div v-if="error" class="error-state">
        <p>Error loading quests: {{ error }}</p>
      </div>
...
const { data: wikiData, loading, error, loadData } = useWikiData('quests')
