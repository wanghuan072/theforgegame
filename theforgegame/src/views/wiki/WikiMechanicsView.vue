<template>
  <div class="wiki-mechanics-view page-container">
    <div class="container">
      <div class="page-header">
        <h1 class="page-title">The Forge Roblox Mechanics</h1>
        <p class="page-subtitle">
          Complete guide to all game mechanics in The Forge. Learn how different systems work and how to master them.
        </p>
      </div>
      ...
      <div v-if="error" class="error-state">
        <p>Error loading mechanics: {{ error }}</p>
      </div>

      <div v-if="!loading && !error">
        <div
          v-for="section in mechanicSections"
          :key="section.key"
          class="table-section"
        >
...
const { data: wikiData, loading, error, loadData } = useWikiData('mechanics')
...
const mechanicSections = computed(() => {
...
const onItemClick = (item) => {
  ...
  if (item.addressBar) {
    ...
    router.push(`/wiki/mechanics/${slug}`)
  }
}
