      ...
      <div class="container">
        <div class="content-wrapper">
          <div class="legal-text">
            ...
            <h2>Email</h2>
            <p>
              For general inquiries, please email us at: <a href="mailto:wyong@theforgegame.com">wyong@theforgegame.com</a>
            </p>
            ...
            <ul>
              ...
              <li>General feedback about The Forge Game Community</li>
            </ul>
            ...
            <h2>Privacy</h2>
            <p>
              Any information you provide in your correspondence will be kept confidential and used only for the purpose of responding to your inquiry. Please review our <router-link to="/privacy-policy">Privacy Policy</router-link> for more information.
            </p>

            <h2>Thank You</h2>
            <p>
              Thank you for your interest in The Forge Game Community. We look forward to hearing from you!
            </p>
          </div>
        </div>
      </div>
